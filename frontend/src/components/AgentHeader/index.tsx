...
import { c } from 'nuqs/dist/serializer-_rJbONuT';
...
const Header = memo(({ queue_size, showQueueSize = true, showCredits = true }: { queue_size: number; showQueueSize?: boolean; showCredits?: boolean; }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      clearTimeout(timeoutIdRef.current); // Clear the timeout in the cleanup function
    };
  }, []);
