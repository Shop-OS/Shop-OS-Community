...
import useProductBG from '@/app/product-background-enhancer/provider/useProductBG';



function GenerationHistory() {
    const { generationHistory, setGenerationHistory, currentHistory, setCurrentHistory, setPreviewImageSrc } = useProductBG();
    ...
    const getHistory = async () => {
        try {
            ...
            setCurrentHistory({});
            const response = await AxiosProvider.get('api/generations?target=product');
