...
import { Button, Dropdown, Input, MenuProps, Slider } from 'antd';
import * as React from 'react';
import UploadRefImage from '../../components/uploadRefImage/UploadRefImage';
...
const AgentEditor = ({
  ...
  return (
    <div style={{ marginLeft: 20, marginTop: 10, marginRight: 20, fontFamily: "BDO Grotesk, sans-serif", }}>
