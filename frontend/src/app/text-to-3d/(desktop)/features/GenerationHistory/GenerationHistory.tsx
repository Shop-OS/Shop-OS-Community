...
import useTextTo3D from '@/app/text-to-3d/provider/useTextTo3D';

function GenerationHistory() {
    const { generationHistory, setGenerationHistory, currentHistory, setCurrentHistory } = useTextTo3D();
    ...
    const getHistory = async () => {
        try {
            ...
            setCurrentHistory({});
            const response = await AxiosProvider.get('api/generations?target=image_to_3d');
                    ...
                    generationHistory.map((item: any, index: number) => (
                        <div
                            ...
                            onClick={() => {
                                ...
                                console.log("first", currentHistory)
                            }}
                        >
                            <img
                                height={40}
