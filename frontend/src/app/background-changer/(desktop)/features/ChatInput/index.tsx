...
const ChatInput = memo<InputAreaProps>(
  ({ handlePromptChange, handleCreateImage, textAreaRef, prompt }) => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Footer handleCreateImage={handleCreateImage} setExpand={setExpand} />
        </Flexbox>
      </DraggablePanel>
    );
  },
