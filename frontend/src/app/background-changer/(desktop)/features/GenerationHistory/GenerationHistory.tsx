...
import useBackgroundChanger from '@/app/background-changer/provider/useBackgroundChanger';



function GenerationHistory() {
    const { generationHistory, setGenerationHistory, currentHistory, setCurrentHistory, setPreviewImageSrc } = useBackgroundChanger();
    ...
    const getHistory = async () => {
        try {
            ...
            setCurrentHistory({});
            const response = await AxiosProvider.get('api/generations?target=backgroundChangeB');
