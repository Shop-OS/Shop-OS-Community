    ...
    <>
      ...
      {/* <div>
        <ActionIcon
          ...
          title={'Editor'}
          onClick={(e) => {
            if (process.env.NEXT_PUBLIC_ENVIRONMENT === 'production' || process.env.NEXT_PUBLIC_ENVIRONMENT === 'staging') return;
            setAgentInputComponent('editor');
          }}
          disable={isDisabled ? isDisabled : (
            process.env.NEXT_PUBLIC_ENVIRONMENT === 'production' || process.env.NEXT_PUBLIC_ENVIRONMENT === 'staging') && true}
        />
      </div> */}
      <div onClick={(e) => { }}>
        <ActionIcon
