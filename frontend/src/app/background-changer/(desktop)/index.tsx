...
import { BackgroundChangerProvider } from '../provider/BackgroundChangerProvider';
...
const DesktopPage = () => {
  ...
  useEffect(() => {
    let showTour = Cookies.get('hom_tour_bg') == 'true' ? true : false;

    if (!showTour) {
      Cookies.set('hom_tour_bg', 'true', { expires: 365 });
      setShowTour(true);
      setTourType('Background Changer');
    }
  }, []);
